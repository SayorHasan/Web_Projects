    ...
    <div class="container">
        ...
        <div class="profile-header">
            <h1 class="profile-title">
                <i class="fas fa-user-shield me-3"></i>Admin Profile Settings
            </h1>
            <p class="text-muted">Manage your administrator account information and preferences</p>
        </div>
            ...
            <div class="col-lg-10">
                ...
                <div class="stats-section">
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-item">
                            <div class="stat-number">{{ $totalTurfs }}</div>
...
document.querySelectorAll('form').forEach(form => {
    form.addEventListener('submit', function(e) {
        ...
        // The controller will handle the validation and updates
    });
});
</script>
@endsection
